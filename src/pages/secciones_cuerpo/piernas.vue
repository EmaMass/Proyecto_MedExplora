<template>
  <BodySectionLayout
    title="piernas"
    subtitle="Extremidades Inferiores"
    icon="mdi-arm-flex"
...
const loadModel = () => {
  ...
  loader.load(
    ...
    (gltf) => {
      ...
      console.log('✓ Modelo de piernas cargado')
    },
    (progress) => {
    ...
    (error) => {
      ...
      errorMessage.value = 'No se pudo cargar el modelo 3D. Verifica que piernas.glb existe en /src/assets/'
      isLoadingModel.value = false
    }
  )
}
